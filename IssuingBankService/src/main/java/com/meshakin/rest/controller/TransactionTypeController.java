...
@RequestMapping("admin/transactionTypes")
public class TransactionTypeController {
    ...
    public ResponseEntity<List<TransactionTypeDtoWithId>> getAllTransactionTypes() {
        return ResponseEntity.ok(transactionTypeService.readAll());
    }

    @GetMapping("/{id}")
    public ResponseEntity<TransactionTypeDtoWithId> getTransactionTypeById(
    ...
    @PostMapping
    public ResponseEntity<TransactionTypeDtoWithId> saveTransactionType(@Valid @RequestBody TransactionTypeDtoWithoutId transactionTypeDtoWithoutId) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<TransactionTypeDtoWithId> updateTransactionType(@Valid @RequestBody TransactionTypeDtoWithId transactionTypeDtoWithId) {
        try {
