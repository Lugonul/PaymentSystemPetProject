...
public class TransactionTypeService {
    ...
    @Cacheable(value = "service1:TransactionTypes", key = "#id")
    ...
    @Transactional
    @CachePut(value = "service1:TransactionTypes", key = "#dto.id")
    ...
    @Transactional
    @CacheEvict(value = "service1:TransactionTypes", key = "#id")
    ...
    @Transactional
    @CacheEvict(value = "service1:TransactionTypes", allEntries = true)
